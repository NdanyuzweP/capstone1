...
const translations: Translations = {
  ...
  aboutRidra: { en: 'About Ridra', rw: 'Ibyerekeye Ridra' },
  ...
  ok: { en: 'OK', rw: 'Sawa' },
  thankYou: { en: 'Thank you for using Ridra! Your feedback helps us improve.', rw: 'Urakoze gukoresha Ridra! Ibisubizo byawe bidufasha guhindura neza.' },
  aboutDescription: { en: 'Ridra - Your trusted ride-sharing companion in Rwanda.\n\nVersion: 1.0.0\nBuild: 2024.1\n\n© 2024 Ridra. All rights reserved.', rw: 'Ridra - Umufasha wawe wizigirwa wo gusangira urugendo muri Rwanda.\n\nVerisiyo: 1.0.0\nUbubiko: 2024.1\n\n© 2024 Ridra. Amahoro yose yarafunguwe.' },
  supportInfo: { en: 'Get in touch with our support team\n\nEmail: support@ridra.com\nPhone: +250 123 456 789', rw: 'Twandikire ishyirahamwe ryawe ryo gufasha\n\nImeri: support@ridra.com\nTelefoni: +250 123 456 789' },
  ridraPassengerApp: { en: 'Ridra Passenger App v1.0.0', rw: 'Ibikoresho by\'Umugenzi Ridra v1.0.0' },
  allRightsReserved: { en: '© 2024 Ridra. All rights reserved.', rw: '© 2024 Ridra. Amahoro yose yarafunguwe.' },
